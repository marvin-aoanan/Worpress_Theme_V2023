...
/*
Plugin Name: Custom Embed Video Widget
...
class widget_embed extends WP_Widget_Text { 
	...
	function widget_embed() {
		...
		$this->WP_Widget( 'embed', __('Custom Video Embed'), $widget_ops, $control_ops );
	}
	...
	function form($instance) {
        ...
        <p>
			<label for="<?php echo $this->get_field_id( 'embed' ); ?>">Embed Video Code:</label>
			<textarea class="widefat" rows="4" cols="20" placeholder="ex:<iframe width='300' height='240' src='//www.youtube.com/embed/uAot9_rejIM?rel=0' frameborder='0' allowfullscreen></iframe>" id="<?php echo $this->get_field_id( 'embed' ); ?>" name="<?php echo $this->get_field_name( 'embed' ); ?>"><?php echo $instance['embed']; ?></textarea>
		</p>
		<p>
