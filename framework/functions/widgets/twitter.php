...
class widget_twitter extends WP_Widget { 
	...
	function con() {
		...
		$this->__construct( 'twitter', __('Custom Twitter Widget'), $widget_ops, $control_ops );
	}
	...
	function form($instance) {
		...
		$defaults = array( 'title' => 'Twitter Widget', 'posts' => '3', 'username' => 'cybrosolutions' ); // Default Values
